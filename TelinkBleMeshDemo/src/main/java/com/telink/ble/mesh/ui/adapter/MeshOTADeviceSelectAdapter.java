...
//                holder.iv_complete.setColorFilter(R.color.colorPrimary);
    ...
    private boolean isFirmwareUpdateSupport(DeviceInfo nodeInfo) {
        return nodeInfo.getTargetEleAdr(MeshSigModel.SIG_MD_FW_UPDATE_S.modelId) != -1;
    }


    private String getDeviceFirmwareId(DeviceInfo deviceInfo) {
    ...
    private int getDeviceState(DeviceInfo deviceInfo) {
