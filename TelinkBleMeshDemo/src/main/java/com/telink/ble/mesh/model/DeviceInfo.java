...
public class DeviceInfo implements Serializable {
    ...
    public List<TimerInfo> timers = new ArrayList<>();
    public List<DeviceInfo> adjoins = new ArrayList<>();

    private boolean getTimerById(int id) {
        Iterator<TimerInfo> iterator = timers.iterator();
    ...
    private OfflineCheckTask offlineCheckTask = new OfflineCheckTask() {
        ...
        public void run() {
            ...
            TelinkMeshApplication.getInstance().dispatchEvent(new NodeStatusChangedEvent(TelinkMeshApplication.getInstance(), NodeStatusChangedEvent.EVENT_TYPE_NODE_STATUS_CHANGED, DeviceInfo.this));
        }
    };
