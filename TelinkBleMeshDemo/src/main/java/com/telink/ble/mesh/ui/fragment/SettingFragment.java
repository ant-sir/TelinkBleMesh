            ...
            case R.id.view_user:
                ...
                addGroupDialogActivity.setOnCancelListener(new AddGroupDialogActivity.IOnCancelListener() {
                    ...
                    public void OnConfirm(AddGroupDialogActivity dialog) {
                        TelinkMeshApplication.getInstance().getMeshInfo().companyName = dialog.textInputEditText.getText().toString();
                        TelinkMeshApplication.getInstance().getMeshInfo().saveOrUpdate(getActivity());
                    }
                }).show();
                addGroupDialogActivity.setTitleName("Enter company name");
                addGroupDialogActivity.setInputHint("company name");
                break;
