...
public class GroupAdapter extends BaseRecyclerViewAdapter<GroupAdapter.ViewHolder> {
    ...
    private CompoundButton.OnCheckedChangeListener switchListener = new CompoundButton.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton v, boolean isChecked) {
            ...
            MeshLogger.log(String.valueOf(mGroups.get(position).address), "zyl", MeshLogger.LEVEL_INFO);
            TransMeshMessage.getInstance().SetBrodCastOnOff(mGroups.get(position).address, isChecked ? 1 : 0);
        }
    };
