...
import com.telink.ble.mesh.ui.fragment.DeviceAdjoinFragment;
...
import com.telink.ble.mesh.ui.fragment.DeviceTimerFragment;
...
//        TelinkMeshApplication.getInstance().addEventListener(NotificationEvent.EVENT_TYPE_KICK_OUT_CONFIRM, this);
    ...
    private void initTab() {
        ...
        Fragment timerFragment = new DeviceTimerFragment();
        timerFragment.setArguments(bundle);

        Fragment adjoinFragment = new DeviceAdjoinFragment();
        adjoinFragment.setArguments(bundle);
